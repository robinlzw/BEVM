...
//! Common concepts with regard to the BEVM Mining system, particularly the user-level ones.
//!
//! There are two approaches of mining in BEVM:
//!
...
//! the staking reward.
//!
//! 2. One goal of BEVM is to embrace more the eixsting cryptocurrencies into one ecosystem,
//! therefore **Asset Mining** is introduced for winning more external assets like BTC, ETH, etc.
//! For example, Bitcoin users can deposit their BTC into BEVM, then they'll get the X_BTC
//! in 1:1 and the mining rights in BEVM system accordingly, earning the new minted PCX
...
//! ```
//!
//! All the nominators split the reward of the validator's reward pot according to the proportion of
//! vote weight.
//!
//! For Asset Mining:
//!
...
//! ```
//!
//! All asset miners split the reward of asset's reward pot according to the proportion of asset
//! mining weight.
...
/// Weight Formula:
///
/// LatestVoteWeight(WeightType) = last_acum_weight(WeightType) + amount(Balance) *
